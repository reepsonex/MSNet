from OrthogonalAttention import *
...
class net(nn.Module):
    def __init__(self, piexl_num = 64):
        ...
        self.att1 = OrthAtt(64)
        self.att2 = OrthAtt(128)
        self.att3 = OrthAtt(256)
        self.att4 = OrthAtt(512)

        self.BE = CCA(512)

        self.MM1 =HierarchicalMultiScaleRegionLayer([[2, 2],[4, 4]], in_channels=64, out_channels=2, kernel_size=3)
        self.MM2 = HierarchicalMultiScaleRegionLayer([[2, 2], [4, 4]], in_channels=128, out_channels=2, kernel_size=3)
        self.MM3 = HierarchicalMultiScaleRegionLayer([[2, 2], [4, 4]], in_channels=256, out_channels=2, kernel_size=3)
        self.MM4 = HierarchicalMultiScaleRegionLayer([[2, 2], [4, 4]], in_channels=512, out_channels=2, kernel_size=3)
    ...
    def forward(self, x):
        ...
        # f1 = self.channel_64(f1)
        # f3 = self.channel_256(f3)
        # f4 = self.channel_512(f4)
        # f5 = self.channel_512(f5)
...
class Update(nn.Module):
    ...
    def __init__(self, pixel_num, in_channels):
        ...
        # self.linear1 = nn.Linear(pixel_num*pixel_num, pixel_num)
        # self.linear2 = nn.Linear(pixel_num, pixel_num*pixel_num)
    ...
    def forward(self, f_next, f):
        ...
        # feature_update = self.linear1(feature_trans)
        # feature_update = self.linear2(feature_update)
